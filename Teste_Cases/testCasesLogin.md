...
| 2     | Clicar no botão "Criar conta" no canto superior direito| Modal ou tela de cadastro é exibido                                      |
| 3     | Preencher os campos: nome, e-mail, senha               | Os campos são preenchidos corretamente sem validações falhando           |
| 4     | Preencher o campo de confirmação de senha              | Os campo foi preenchido corretamente com a mesma string da senha         |
| 5     | Clicar no botão "Cadastrar"                            | Mensagem de sucesso é exibida e o usuário é redirecionado/logado         |
...
| 1     | Acessar a página inicial da Kasa.live                  | Página inicial é exibida corretamente                                              |
| 2     | Clicar no botão "Criar conta" no canto superior direito| Modal ou tela de cadastro é exibido                                               |
| 3     | Preencher os campos: nome, e-mail `teste@exemplo.com`, senha | Os campos são preenchidos corretamente                                       |
| 4     | Marcar a caixa de aceite dos Termos de Uso             | A caixa é marcada com sucesso                                                      |
| 5     | Clicar no botão "Cadastrar"                            | Uma mensagem de erro informando que o e-mail já está em uso deve ser exibida      |

## Resultado Esperado
O sistema bloqueia o cadastro e exibe uma mensagem clara como: "E-mail já cadastrado. Tente fazer login ou recuperar sua senha."
...
## Resultado Esperado
O usuário acessa sua conta com sucesso e visualiza sua sessão autenticada, incluindo favoritos e configurações personalizadas.


# CT-004: Login com e-mail ou senha inválidos - Usuário registrado
...
## Resultado Esperado
O sistema exibe uma mensagem de erro clara como: "E-mail ou senha incorretos" e impede o acesso à conta.
...
| 3     | Clicar em "Excluir conta"                                  | Um modal de confirmação é exibido solicitando a confirmação da ação            |
...
| 3     | Clicar em "Entrar com o Google"                            | Uma nova janela ou modal de autenticação do Google é exibida                       |
| 4     | Selecionar uma conta Google válida                        | Processo de autenticação é iniciado                                                |
| 5     | Conceder permissões, se solicitado                        | O usuário é redirecionado de volta para o site                                     |
